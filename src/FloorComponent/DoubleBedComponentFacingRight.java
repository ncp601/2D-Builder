...
public class DoubleBedComponentFacingRight extends FloorComponent{
	...
	final private String componentType = "DOUBLEBEDFR";
	...
	public DoubleBedComponentFacingRight(boolean m){
		this.inMenu = m;

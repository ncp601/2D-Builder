...
public class BathroomSinkComponentFacingLeft extends FloorComponent{
	...
	final private String componentType = "SINKFL";
	...
	public BathroomSinkComponentFacingLeft(boolean m){
		this.inMenu = m;

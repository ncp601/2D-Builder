...
public class DoorComponentFacingUpOpenLeft extends FloorComponent{
	...
	public DoorComponentFacingUpOpenLeft(boolean m){
		this.inMenu = m;
	...
	public void createComponent(){
		...
		if(inMenu){
			ImageIcon image = new ImageIcon("images/doorFacingUpOpenLeft.png");
			setIcon(image);
			setMaximumSize(size);
			setMinimumSize(size);
		...
		if(!inMenu){
			ImageIcon image = new ImageIcon("images/resizedDoorFacingUpOpenLeft.png");
			setIcon(image);

	...
	public void mousePressed(MouseEvent e){
		...
		pressedOperation = true;
			...
			if(!(innerPanel.getInMainLayeredPane()) && !(currentComponent.getIsOnGrid()) && pressedOperation){
		    	...
		    	if(kitchenFactory.getComponent(type) != null){
		    		newComponent = kitchenFactory.getGridComponent(type);
		    	}
		    	...
		    	if(livingRoomFactory.getComponent(type) != null){
		    		newComponent = livingRoomFactory.getGridComponent(type);
		    	}

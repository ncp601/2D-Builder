...
public class MenuPane extends JPanel{
    ...
    private AbstractFloorComponentFactory kitchenFactory;
    ...
    private AbstractFloorComponentFactory livingRoomFactory;
    ...
    public MenuPane(TabbedPane tab) {
      ...
      //Assigns the factories for each type of component
        ...
        kitchenFactory = FloorComponentFactoryProducer.getFactory("KITCHEN");
        dinningRoomFactory = FloorComponentFactoryProducer.getFactory("DINNINGROOM");
        livingRoomFactory = FloorComponentFactoryProducer.getFactory("LIVINGROOM");
      ...
      //Creates the backButton that will redirect users from the various component tabs back to the main menu
        ...
        livingRoomMenuPanel.add(livingRoomFactory.getComponent("SIMPLECOUCHFD"));
        livingRoomMenuPanel.add(livingRoomFactory.getComponent("ARMCHAIRFD"));
      ...
      //Creates the dinningRoomMenuPanel that will hold dinning room components
        ...
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGTABLEV"));  
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGTABLEH"));
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGCHAIRFD"));
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGCHAIRFU"));
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGCHAIRFR"));
        dinningRoomMenuPanel.add(dinningRoomFactory.getComponent("DINNINGCHAIRFL"));
      ...
      //Creates the bedroomMenuPanel that will hold wall components
        ...
        bedroomMenuPanel.add(bedroomFactory.getComponent("DOUBLEBEDFD"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("DOUBLEBEDFU"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("DOUBLEBEDFR"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("DOUBLEBEDFL"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("SINGLEBEDFR"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("SINGLEBEDFL"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("SINGLEBEDFD"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("SINGLEBEDFU"));
        bedroomMenuPanel.add(bedroomFactory.getComponent("BEDTABLE1"));
      ...
      //Creates the kitchenMenuPanel that will hold kitchen components
        ...
        kitchenMenuPanel.add(kitchenFactory.getComponent("STOVEFD"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("STOVEFU"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("STOVEFR"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("STOVEFL"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("KITCHENCOUNTER1B"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("KITCHENCOUNTER2H"));
        kitchenMenuPanel.add(kitchenFactory.getComponent("KITCHENCOUNTER2V"));
      ...
      //Creates the bathroomMenuPanel that will hold bathroom components
        ...
        bathroomMenuPanel.add(bathroomFactory.getComponent("TOILETFD")); 
        bathroomMenuPanel.add(bathroomFactory.getComponent("TOILETFU")); 
        bathroomMenuPanel.add(bathroomFactory.getComponent("TOILETFR")); 
        bathroomMenuPanel.add(bathroomFactory.getComponent("TOILETFL")); 
        bathroomMenuPanel.add(bathroomFactory.getComponent("SINKFD")); 
